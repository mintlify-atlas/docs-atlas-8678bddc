...
description: "Buildml is an interactive platform to learn AI/ML by implementing algorithms from scratch. Write Python, run tests, and track progress with a community leaderboard."
---
